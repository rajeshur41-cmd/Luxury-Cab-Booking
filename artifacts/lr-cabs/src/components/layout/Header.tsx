        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex items-center">
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-[#f4b400] to-[#f5d061] text-black px-6 py-2.5 rounded-full font-bold text-sm hover:shadow-lg hover:scale-105 transition-all whitespace-nowrap"
            >
              ...
              <SheetContent side="right" className="bg-[#111] border-l-border/10 p-0 w-72">
                <div className="p-6 flex flex-col h-full">
                  ...
                  <div className="mt-10">
                    <button
                      onClick={() => setCallOpen(true)}
                      className="flex items-center justify-center gap-2 bg-gradient-to-r from-[#f4b400] to-[#f5d061] text-black w-full py-4 rounded-full font-bold text-base"
                    >
